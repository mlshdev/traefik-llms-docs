...
source_url: "https://github.com/traefik/traefik/blob/ead8b92dba6eca8c19e40287f986dc54a57325f4/docs/content/security/http2-header-memory.md"
---
...
The [`maxHeaderBytes`](../reference/install-configuration/entrypoints.md#opt-http-maxHeaderBytes) option caps the size, in bytes, of the request headers Traefik reads for each request.
...
The [`maxConcurrentStreams`](../reference/install-configuration/entrypoints.md#opt-http2-maxConcurrentStreams) option caps the number of concurrent HTTP/2 streams each client is allowed to initiate on a single connection (default `250`).
