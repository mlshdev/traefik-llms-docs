...
section: "Reference"
breadcrumb: "Reference / Routing Configuration / Kubernetes / Ingress"
traefik_version: "v3.7"
upstream_path: "docs/content/reference/routing-configuration/kubernetes/ingress.md"
source_url: "https://github.com/traefik/traefik/blob/faa1eb590646aed94e561e24a59be0c47353ae95/docs/content/reference/routing-configuration/kubernetes/ingress.md"
---
...
| <a id="opt-traefik-ingress-kubernetes-iorouter-tls-options" href="#opt-traefik-ingress-kubernetes-iorouter-tls-options" title="#opt-traefik-ingress-kubernetes-iorouter-tls-options">`traefik.ingress.kubernetes.io/router.tls.options`</a> | See [TLS options](../kubernetes/crd/tls/tlsoption.md) for more information.<br/>The TLS options are mapped to the host names of the Ingress rules, and not to the Ingress itself, so an Ingress serving a host name already served with different TLS options, in any namespace, makes them conflict.<br/>See [Conflicting TLS Options](../http/tls/tls-options.md#conflicting-tls-options) for more information. | `foobar@file` |
